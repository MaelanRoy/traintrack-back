...
import com.example.traintrack_back.api.configuration.validation.validator.MustBeTheSameAsInPathValidator;

/**
 * Spring validation annotation validated by {@link MustBeTheSameAsInPathValidator}. <br/>
...
@Constraint(validatedBy = MustBeTheSameAsInPathValidator.class)
public @interface MustBeTheSameAsInPath {
